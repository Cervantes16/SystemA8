...
const Empaques: React.FC = () => {
  ...
  const [empaques, setEmpaques] = useState<EmpaqueItem[]>([]);
  const [detalleEmpaques, setDetalleEmpaques] = useState<EmpaqueDetalle[]>([]);
  const [tallasDetalle, setTallasDetalle] = useState<TallaDetalle[]>([]);
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      readOnly
                      className="flex-1 px-3 py-2 border border-gray-600 rounded-l-md bg-gray-100"
                    />
                    <span className="flex-1 px-3 py-2 bg-gray-200 border border-l-0 border-gray-600 rounded-r-md text-center">
                      %
                    </span>
                  </div>
                </div>
          ...
          <table className="w-full table-auto">
            <thead className="sticky top-0 bg-gray-50">
              <tr className="border-b border-gray-200">
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-16 sm:w-20">
                  ID
                </th>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-24 sm:w-32">
                  KILOGRAMOS
                </th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-20 sm:w-24">
                  CARTONES
                </th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider sm:min-w-[120px]">
                  GRANJA
                </th>
